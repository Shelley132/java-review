...
public class L4_MedianofTwoSortedArrays {
	...
	public static void main(String[] args) {
		...
		System.out.println(new L4_MedianofTwoSortedArrays().findMedianSortedArrays(nums1, nums2));
		int[] nums3 = {416,456,567,588};
		int[] nums4 = {878,888,989};
		System.out.println(new L4_MedianofTwoSortedArrays().findMedianSortedArrays(nums3, nums4));
	}
