...
public class GenerateInputs2 {
	...
	public List<Set<String>> allSubset(String infile) {
		...
		appendToFileEnd("/usr/local/arm/data/printtokens_2.0/printtokens/inputs/numbers",
				infile.substring(infile.lastIndexOf("/") + 1) + "=" + list.size() + "\n");
	...
	public boolean runShell(String checkShellName) {
	...
	public static void main(String[] args) {
		String name = args[0];
		GenerateInputs2 obj = new GenerateInputs2();
		List<Set<String>> lists = obj.allSubset("/usr/local/arm/data/printtokens_2.0/printtokens/inputs/" + name);
		for (int i = 0; i < lists.size(); i++) {
			...
			obj.writeFile("/usr/local/arm/data/printtokens_2.0/printtokens/inputs/" + name + "-" + i,
					outStr.toString());
		}
	}
}
